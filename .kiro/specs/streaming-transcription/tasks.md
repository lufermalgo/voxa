...
- [ ] 1. Spike: validate approach and latency win (decision gate)
...
- [ ] 2. Add `streaming_stt` setting + fallback scaffolding
  - Add an off-by-default flag; wire the pipeline so off == current batch behavior.
  - _Requirements: 6.2_

- [ ] 3. Incremental VAD during capture (B7)
...
- [ ] 6. Seam assembly + de-duplication
