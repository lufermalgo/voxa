...
export const RecorderPill = ({ status }: RecorderPillProps) => {
  ...
  if (isRecording) {
    return (
      <div className="animate-in fade-in zoom-in-95 duration-500">
        <div className="obsidian-glass h-7 px-2 rounded-full flex items-center gap-1.5 shadow-2xl border border-white/10 relative overflow-hidden ring-1 ring-black/50">
